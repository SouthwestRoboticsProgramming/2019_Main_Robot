...
//   public RobotMap() {;}
  ...
  // ids
	public static final int LEFT_REAR_MOTOR = 3;  // this is all assuming that forward is claw side.
	...
	public static final int LOWER_WRIST_LIMIT_SWITCH = 1;
	public static final int UPPER_WRIST_LIMIT_SWITCH = 2;
	public static final int LOWER_EXTEND_LIMIT_SWITCH = 0; 
	public static final int UPPER_EXTEND_LIMIT_SWITCH = 7; 
